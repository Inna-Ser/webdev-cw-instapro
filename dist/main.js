...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderAddPostPageComponent: () => (/* binding */ renderAddPostPageComponent)\n/* harmony export */ });\n/* harmony import */ var _header_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header-component */ \"./components/header-component.js\");\n/* harmony import */ var _upload_image_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./upload-image-component */ \"./components/upload-image-component.js\");\n\r\n\r\n\r\nfunction renderAddPostPageComponent({\r\n  appEl,\r\n  onAddPostClick\r\n}) {\r\n  let imageUrl = \"\"\r\n  const render = () => {\r\n    // TODO: Реализовать страницу добавления поста\r\n    const appHtml = `\r\n    <div class=\"page-container\">\r\n      <div class=\"header-container\">\r\n      </div>\r\n      <div class=\"form\">\r\n      <div class=\"form-inputs\">\r\n        <h3 class=\"form-title\"> Добавить пост </h3>\r\n        <div class=\"upload-image-container\"></div>\r\n        <label> \r\n        Опишите фотографию:\r\n          <textarea class=\"input textarea\" rows=\"4\"></textarea>\r\n        </label>\r\n        <button class=\"button\" id=\"add-button\">Добавить</button>\r\n        </div>\r\n      </div>\r\n  `;\r\n\r\n    appEl.innerHTML = appHtml;\r\n\r\n// что это значит?\r\n    const uploadImageContainer = appEl.querySelector(\".upload-image-container\");\r\n\r\n    (0,_header_component__WEBPACK_IMPORTED_MODULE_0__.renderHeaderComponent)({\r\n      element: document.querySelector(\".header-container\"),\r\n    });\r\n\r\n    if (uploadImageContainer) {\r\n      (0,_upload_image_component__WEBPACK_IMPORTED_MODULE_1__.renderUploadImageComponent)({\r\n        element: appEl.querySelector(\".upload-image-container\"),\r\n        onImageUrlChange(newImageUrl) {\r\n          imageUrl = newImageUrl;\r\n        },\r\n      });\r\n    }\r\n    // toDo получить текст по селектору\r\n    let textPost = document.querySelector(\"textarea\").value\r\n\r\n    document.getElementById(\"add-button\").addEventListener(\"click\", () => {\r\n      onAddPostClick({\r\n        description: \"Описание картинки\",\r\n        textPost,\r\n        imageUrl: imageUrl,\r\n      });\r\n      renderAddPostPageComponent()\r\n    });\r\n  };\r\n\r\n  render();\r\n}\n\n//# sourceURL=webpack://webdev-cw-instapro/./components/add-post-page-component.js?");
